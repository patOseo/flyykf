		...
		<?php $i = 1; while(have_rows('accordion')): the_row(); ?>
			...
			<div class="accordion-card">
				<div class="hover position-relative mb-3 bg-light" id="heading<?php echo $i; ?>">
					...
					<button class="collapsed d-flex align-items-center w-100 py-3 border-0 <?php echo esc_attr($btnsize); ?> fw-bold text-start bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $i; ?>-<?= $random; ?>" aria-expanded="false" aria-controls="collapse<?php echo $i; ?>">
